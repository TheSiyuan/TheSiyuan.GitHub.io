...
(function($){
    ...
    $.jSlots = function(el, options){
        ...
        base.fixedgame = function(fixednumber) {
            return fixednumber;
        }
        // --------------------------------------------------------------------- //
        // VARS
        ...
        base.Slot.prototype = {
            ...
            finish : function() {
                ...
                var that = this;
                var whatsthenum = base.options.fixedvalue;
                //var endNum = base.randomRange( 2, base.liCount );
                //var endNum = base.randomRange( 1, 10 );
                var endNum = base.fixedgame(whatsthenum);
